...
/**
 * 
 * ClassName: DeliverIntimeRate 
 * @author 刘镇松
 * @date 2016年8月25日
 * @version V1.0
 */
public class DeliverIntimeRate {
    private BigDecimal intimerateId;
    ...
    public String getTargetValueMax() {
        return targetValueMax;
    }

    public void setTargetValueMax(String targetValueMax) {
    ...
    public BigDecimal getIntimerateId() {
		return intimerateId;
	}

	public void setIntimerateId(BigDecimal intimerateId) {
		this.intimerateId = intimerateId;
	}
