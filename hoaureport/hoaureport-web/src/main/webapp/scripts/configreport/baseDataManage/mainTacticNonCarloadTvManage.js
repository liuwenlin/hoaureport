/**主界面->部门负责人*/
Ext.define('Ty.Report.MainTacticNonCarloadTv.MainTacticNonCarloadTvModel', {
...
/***主界面->次日送达率store*/
Ext.define('Ty.Report.MainTacticNonCarloadTv.MainTacticNonCarloadTvStore', {
	extend : 'Ext.data.Store',
	model : 'Ty.Report.MainTacticNonCarloadTv.MainTacticNonCarloadTvModel',
	pageSize : 100,// 分页条数
	proxy : {
		type : 'ajax',
		url : 'mainTacticNonCarloadTvAction!queryInfo.action',
		actionMethods : 'POST',
		reader : {
			type : 'json',
...
Ext.onReady(function(){
	...
	*/
	...
	//主界面->表格->store
		var managerStore=Ext.create('Ty.Report.MainTacticNonCarloadTv.MainTacticNonCarloadTvStore',{
			id:'managerStoreId'
		});
		...
		var  managerGrid =Ext.create('Ext.grid.Panel', {
	        ...
	        listeners : {
			 ...
			 dockedItems:[{//分页
		 			xtype:'pagingtoolbar',
		 			id: 'queryMainTacticNonCarloadTvGridPaginId',
		 			store:managerStore,
		 			dock:'bottom',
		 			displayInfo : true,
		 			autoScroll : true
...
function imple(outFileName,flag){
			if(flag){
				...
				Ext.Ajax.request( {  
			       url : 'mainTacticNonCarloadTvAction!implExcel.action',  
			       method : 'post',  
			       params : {  
