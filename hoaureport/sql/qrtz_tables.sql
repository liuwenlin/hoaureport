...
delete from QRTZ_JOB_SCHEDULES;
delete from QRTZ_JOB_PLANNINGS;
delete from QRTZ_JOB_LOGGINGS;
...
drop table QRTZ_JOB_SCHEDULES;
drop table QRTZ_JOB_PLANNINGS;
drop table QRTZ_JOB_LOGGINGS;
...
CREATE TABLE QRTZ_JOB_SCHEDULES
  (
    ...
    JOB_CLASS VARCHAR2(250),
    JOB_DATA VARCHAR2(2000),
    CONSTRAINT PRIMARYQRTZ_JOB_SCHEDULES1 PRIMARY KEY (ID)
  );
...
CREATE TABLE QRTZ_JOB_PLANNINGS
  (
    ...
    CONSTRAINT PRIMARYQRTZ_JOB_PLANNINGS1 PRIMARY KEY (INSTANCE_ID, SCOPE_TYPE, SCOPE_NAME,
    ACCESS_RULE)
  );
...
CREATE TABLE QRTZ_JOB_LOGGINGS
  (
    ...
    CONSTRAINT PRIMARYQRTZ_JOB_LOGGINGS1 PRIMARY KEY (ID)
  );
