...
/**
 * 发货准点率目标值
 * ClassName: DispatchOnTimeRate 
 * @author 文洁
 * @date 2016年11月9日
 * @version V1.0
 */
public class DispatchOnTimeRate {
	//发货准点率目标值ID
    private BigDecimal dispatchOnTimeRateId;
    //部门
    ...
    public BigDecimal getDispatchOnTimeRateId() {
		return dispatchOnTimeRateId;
	}

	public void setDispatchOnTimeRateId(BigDecimal dispatchOnTimeRateId) {
		this.dispatchOnTimeRateId = dispatchOnTimeRateId;
	}
