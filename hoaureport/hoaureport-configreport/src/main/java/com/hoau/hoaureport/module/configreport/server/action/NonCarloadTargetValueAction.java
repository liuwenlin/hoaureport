...
import com.hoau.hoaureport.module.configreport.shared.vo.NonCarloadTargetValueVo;
/**
 * 非整车合计目标值
 * @author 刘镇松
 *
 */
@Controller("nonCarloadTargetValueAction")
@Scope("prototype")
public class NonCarloadTargetValueAction extends AbstractAction{

	private static final long serialVersionUID = 1234001094711976030L;
    private  NonCarloadTargetValueVo vo;
    @Resource
	INonCarloadTVService service;
	...
	public NonCarloadTargetValueVo getVo() {
		return vo;
	}

	public void setVo(NonCarloadTargetValueVo vo) {
		this.vo = vo;
	}
