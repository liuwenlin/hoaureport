...
/**
 * 吨成本信息
 * ClassName: TonCostInfo 
 * @author 文洁
 * @date 2016年8月23日
 * @version V1.0
 */
public class TonCostInfo {
	//吨成本ID
    private BigDecimal tonCostId;
    //部门
	...
	public BigDecimal getTonCostId() {
        return tonCostId;
    }

    public void setTonCostId(BigDecimal tonCostId) {
        this.tonCostId = tonCostId;
    }
