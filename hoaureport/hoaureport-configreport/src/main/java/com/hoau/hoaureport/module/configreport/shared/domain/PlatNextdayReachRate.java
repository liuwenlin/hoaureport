...
/**
 * 平台-次日送到率
 * ClassName: PlatNextdayReachRate 
 * @author 文洁
 * @date 2016年10月17日
 * @version V1.0
 */
public class PlatNextdayReachRate {
	//平台-次日送到率ID
    private Long platReachRateId;
    //部门
    ...
    //setters 和 getters
    public Long getPlatReachRateId() {
        return platReachRateId;
    }

    public void setPlatReachRateId(Long platReachRateId) {
        this.platReachRateId = platReachRateId;
    }
