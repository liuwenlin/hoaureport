/**主界面->部门负责人*/
Ext.define('Ty.Report.FranchiseNonCarloadTv.FranchiseNonCarloadTvModel', {
...
/***主界面->次日送达率store*/
Ext.define('Ty.Report.FranchiseNonCarloadTv.FranchiseNonCarloadTvStore', {
	extend : 'Ext.data.Store',
	model : 'Ty.Report.FranchiseNonCarloadTv.FranchiseNonCarloadTvModel',
	pageSize : 100,// 分页条数
	proxy : {
		type : 'ajax',
		url : 'franchiseNonCarloadTvAction!queryInfo.action',
		actionMethods : 'POST',
		reader : {
			type : 'json',
...
Ext.onReady(function(){
	...
	*/
	...
	//主界面->表格->store
		var managerStore=Ext.create('Ty.Report.FranchiseNonCarloadTv.FranchiseNonCarloadTvStore',{
			id:'managerStoreId'
		});
		...
		var  managerGrid =Ext.create('Ext.grid.Panel', {
	        ...
	        listeners : {
			 ...
			 dockedItems:[{//分页
		 			xtype:'pagingtoolbar',
		 			id: 'queryFranchiseNonCarloadTvGridPaginId',
		 			store:managerStore,
		 			dock:'bottom',
		 			displayInfo : true,
		 			autoScroll : true
...
function imple(outFileName,flag){
			if(flag){
				...
				Ext.Ajax.request( {  
			       url : 'franchiseNonCarloadTvAction!implExcel.action',  
			       method : 'post',  
			       params : {  
