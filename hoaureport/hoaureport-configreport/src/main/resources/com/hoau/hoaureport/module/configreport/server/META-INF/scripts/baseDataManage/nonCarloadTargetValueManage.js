/**主界面->部门负责人*/
Ext.define('Ty.Report.NonCarloadTargetValue.NonCarloadTargetValueModel', {
...
/***主界面->次日送达率store*/
Ext.define('Ty.Report.NonCarloadTargetValue.NonCarloadTargetValueStore', {
	extend : 'Ext.data.Store',
	model : 'Ty.Report.NonCarloadTargetValue.NonCarloadTargetValueModel',
	pageSize : 100,// 分页条数
	proxy : {
		type : 'ajax',
		url : 'nonCarloadTargetValueAction!queryInfo.action',
		actionMethods : 'POST',
		reader : {
			type : 'json',
...
Ext.onReady(function(){
	...
	*/
	...
	//主界面->表格->store
		var managerStore=Ext.create('Ty.Report.NonCarloadTargetValue.NonCarloadTargetValueStore',{
			id:'managerStoreId'
		});
		...
		var  managerGrid =Ext.create('Ext.grid.Panel', {
	        ...
	        listeners : {
			 ...
			 dockedItems:[{//分页
		 			xtype:'pagingtoolbar',
		 			id: 'queryNonCarloadTargetValueGridPaginId',
		 			store:managerStore,
		 			dock:'bottom',
		 			displayInfo : true,
		 			autoScroll : true
...
function imple(outFileName,flag){
			if(flag){
				...
				Ext.Ajax.request( {  
			       url : 'nonCarloadTargetValueAction!implExcel.action',  
			       method : 'post',  
			       params : {  
